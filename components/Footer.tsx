...
function Footer() {
  ...
  return (
    <div className='grid grid-cols-2 sticky shadow-lg md:grid-cols-2 gap-y-10 bg-blue-100 md:px-32 px-14 py-14 border-t border-solid rounded-xl border-purple-700 text-gray-600'>
